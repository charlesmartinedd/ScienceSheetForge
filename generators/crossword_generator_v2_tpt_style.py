"""
OPTION 4: Teachers Pay Teachers Professional Style
...
def generate_crossword_tpt_style(standard_data, grade_level, output_filename="crossword_tpt.png"):
    """Generate BEAUTIFUL TPT-style crossword puzzle"""
    ...
    # CLUES SECTION - Beautiful layout
    ...
    print(f"TPT-Style crossword saved: {output_filename}")
...
if __name__ == "__main__":
    ...
    generate_crossword_tpt_style(sample_standard, "6-8", "output/examples/OPTION4_TPT_STYLE_crossword.png")
